...
execute if data entity @s SelectedItem{count:1} run item replace entity @s weapon.mainhand with minecraft:potion[item_name='{"text":"Potion of Reminiscence","color":"aqua","italic":false}',custom_data='{recallpotion:1}',hide_additional_tooltip={},enchantment_glint_override=true,potion_contents={custom_color:249343}] 1
# if the player has more than one empty bottle in their hand
execute unless data entity @s SelectedItem{count:1} run give @s minecraft:potion[item_name='{"text":"Potion of Reminiscence","color":"aqua","italic":false}',custom_data='{recallpotion:1}',hide_additional_tooltip={},enchantment_glint_override=true,potion_contents={custom_color:249343}] 1
